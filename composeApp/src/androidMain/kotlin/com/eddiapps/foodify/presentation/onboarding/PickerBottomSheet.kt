...
fun PickerBottomSheet(
    ...
    val listState = rememberLazyListState(
        initialFirstVisibleItemIndex = rangeList.indexOf(currentValue)
    )
    ...
    LaunchedEffect(listState.firstVisibleItemIndex) {
        selectedValue = rangeList.getOrElse(listState.firstVisibleItemIndex) { currentValue }
    }
    ...
    Column {
        ...
        Box(
            ...
            // Highlight-Linie für ausgewählten Wert
